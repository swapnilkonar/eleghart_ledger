            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text('New Splitz Group', style: GoogleFonts.sora(fontSize: 18, fontWeight: FontWeight.w700, color: textPrimary)),
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Splitz', style: GoogleFonts.sora(fontSize: 20, fontWeight: FontWeight.w800, color: textPrimary)),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Splitz Groups (${_groups.length})', style: GoogleFonts.sora(fontSize: 16, fontWeight: FontWeight.w700, color: textPrimary)),
                            TextButton.icon(
                              onPressed: () => _showCreateGroupModal(isWhite),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text('No Splitz Groups Yet', style: GoogleFonts.sora(fontSize: 16, fontWeight: FontWeight.w700, color: isWhite ? EleghartColors.accentDark : Colors.white)),
          const SizedBox(height: 6),
          Text('Create a Splitz group for trips, flatmates, or dining to split bills offline.', style: GoogleFonts.sora(fontSize: 12, color: isWhite ? Colors.black45 : Colors.white54), textAlign: TextAlign.center),
          const SizedBox(height: 16),
          ElevatedButton.icon(
